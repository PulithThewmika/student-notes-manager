...
/* ── Custom SVG Welcome Loader ── */
function WelcomeLoader() {
  return (
    <div style={{
      position: 'fixed', top: 0, left: 0, width: '100%', height: '100%',
      display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center',
      background: '#f5f4f0', zIndex: 1000
    }}>
      ...
      <h2 style={{ marginTop: '24px', fontSize: '20px', fontWeight: 600, color: '#1a1916', letterSpacing: '-0.02em', background: 'linear-gradient(90deg, #973BED, #007CFF, #00DA72)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
        NovaNotes
      </h2>
    </div>
  );
      ...
      <div style={{ minHeight: "100vh", background: "#f5f4f0" }}>
        ...
        <header style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <span style={{ fontSize: "16px", fontWeight: 700, letterSpacing: "-0.02em", background: "linear-gradient(90deg, #973BED, #007CFF)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
              NovaNotes
            </span>
          </div>
